...
public class KKHandlerAdapter {
    public KKModelAndView handle(HttpServletRequest req, HttpServletResponse resp, KKHandlerMapping handler) throws InvocationTargetException, IllegalAccessException {
        ...
        boolean isModelAndView = handler.getMethod().getReturnType() == KKModelAndView.class;
        if (isModelAndView){
            return (KKModelAndView) result;
        }
        return null;
    }
